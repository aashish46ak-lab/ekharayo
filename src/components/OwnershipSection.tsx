        ...
        <div className="max-w-3xl mx-auto bg-card rounded-2xl border border-border shadow-lg overflow-hidden">
          <div className="md:flex">
            <div className="md:w-2/5 flex items-center justify-center p-6 bg-secondary">
              <img src={founderImg} alt="Founder of Great Himalayan Agro" loading="lazy" width={512} height={512} className="w-48 h-48 md:w-56 md:h-56 rounded-full object-cover border-4 border-primary shadow-lg" />
            </div>
