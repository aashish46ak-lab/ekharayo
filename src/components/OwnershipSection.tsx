        ...
        <div className="max-w-3xl mx-auto bg-card rounded-2xl border border-border shadow-lg overflow-hidden">
          <div className="md:flex">
            <div className="md:w-2/5 flex items-center justify-center p-6 bg-secondary">
              <img src={founderImg} alt="Founder of Great Sagarmatha Traders" loading="lazy" width={512} height={512} className="w-56 h-64 md:w-64 md:h-72 rounded-2xl object-cover border-4 border-primary shadow-lg" />
            </div>
