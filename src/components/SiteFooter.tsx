  ...
  <footer className="border-t border-border bg-card/50 py-8">
    <div className="container mx-auto px-4 flex flex-col items-center gap-3 text-center">
      <Link to="/" className="inline-flex items-center">
        <img src={logo} alt="eKharayo — Great Sagarmatha Agro Pvt. Ltd." className="h-10 w-auto" loading="lazy" />
      </Link>
      <p className="font-body text-xs text-muted-foreground max-w-md">
        The official digital marketplace of Great Sagarmatha Agro Pvt. Ltd. — quality agricultural products from Nepal
