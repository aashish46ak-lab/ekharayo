...
import { Phone, Mail, ShoppingBasket } from "lucide-react";


const Ownership = () => (
  <div className="min-h-screen pt-14">
    <Navbar />
    <PageShell title="Meet the Founder" subtitle="The vision behind Great Sagarmatha Traders PVT LTD">
        ...
        <div className="max-w-3xl mx-auto bg-card rounded-2xl border border-border shadow-xl shadow-primary/5 overflow-hidden">
          <div className="md:flex">
            <div className="md:w-2/5 flex items-center justify-center p-8 bg-gradient-to-br from-primary/10 to-secondary">
              <img src={founderImg} alt="Founder of Great Sagarmatha Traders PVT LTD" loading="lazy" className="w-60 h-68 md:w-64 md:h-76 rounded-2xl object-cover border-4 border-primary/30 shadow-lg" />
            </div>
            <div className="p-8 md:w-3/5 flex flex-col justify-center">
              <h3 className="font-display text-2xl font-bold text-foreground mb-1">Founder & CEO</h3>
              <p className="font-body text-primary font-semibold text-lg mb-1">Great Sagarmatha Traders PVT LTD</p>
              ...
              <div className="space-y-3">
                ...
                <Link to="/products" className="flex items-center gap-3 bg-primary/80 text-primary-foreground font-body text-sm font-semibold px-5 py-3 rounded-lg hover:bg-primary transition-colors">
                  <ShoppingBasket size={18} /> Shop Our Products
                </Link>
